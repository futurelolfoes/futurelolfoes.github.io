...
<head>
	...
	<title>Easy Installer by Soumya Gamer X viserlab</title>
...
<body>
	<header class="py-3 border-bottom border-primary bg--dark">
		<div class="container">
			<div class="d-flex align-items-center justify-content-between header gap-3">
				...
				<h3 class="title">Soumya Gamers X Easy Installer</h3>
			</div>
		</div>
	</header>
					...
					<div class="install-item">
						...
						<div class="box-item">
							...
							if ($action == 'result') {
								...
								if (@$response['error'] == 'ok') {
									echo '<h2 class="text-success text-uppercase mb-3">Your system has been installed successfully! By - Soumya Gamers</h2>';
									if (@$response['message']) {
							...
							?>
								...
								<div class="item">
									<p class="info">For more information, Please Check <a href="https://soumyagamers.com/licenses/" target="_blank">The License FAQ</a></p>
								</div>
	...
	<footer class="py-3 text-center bg--dark border-top border-primary">
		<div class="container">
			<p class="m-0 font-weight-bold">&copy;<?php echo Date('Y') ?> - All Right Reserved by <a href="https://viserlab.com/">Soumya Gamers X ViserLab</a></p>
		</div>
	</footer>
